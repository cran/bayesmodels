...
# TESTS
test_that("svm_reg: stan, (No xregs), Test Model Fit Object", {
    
    testthat::expect_s3_class(model_fit$fit, "svm_stan_fit_impl")
...
test_that("svm_reg: stan, (No xregs), Test Predictions", {
...
# TESTS
test_that("svm_reg: stan (workflow), Test Model Fit Object", {
    
    testthat::expect_s3_class(wflw_fit$fit$fit$fit, "svm_stan_fit_impl")
...
test_that("svm_reg: stan (workflow), Test Predictions", {
